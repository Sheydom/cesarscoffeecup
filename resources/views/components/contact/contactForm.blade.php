<section class="p-5 flex flex-col sm:flex-row w-full justify-center sm:flex md:flex md:justify-center gap-10 lg:gap-20 lg:p-15">
    <div class="flex flex-col w-full gap-5">
        ...
        <div class="mb-10 flex  md:flex  md:max-w-200 h-90"><iframe class="h-full w-full rounded md:block"
