<section class="bg-neutral p-5 gap-5 flex flex-col items-center text-coffeDark">
    <div>
        <h2 class="text-2xl font-bodoni text-primary">Heritage Coffee Roasters</h2>
    </div>
    <div class=" gap-4 flex justify-center w-full  text-black mb-6 ">
                    ...
                    <a  target="_blank"
                        ...
                        <svg class="w-10 h-10 shrink-0 rounded-full p-2 bg-white text-black   md:bg-white md:hover:-translate-y-3 md:hover:text-white md:hover:bg-bean transition duration-300 ease-in-out cursor-pointer"
    ...
    <div class="flex gap-5 justify-center  flex-wrap wrap-break-word">
