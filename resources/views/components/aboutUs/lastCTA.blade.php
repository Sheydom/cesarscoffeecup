<section class="relative flex flex-col items-center gap-3 bg-coffeDark  px-5 py-16 overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col w-full justify-center gap-3 md:flex-row  md:max-w-5xl">
        ...
        <x-ui.buttonClear href="{{route('contact')}}#contactForm" class="border border-neutral/40 text-neutral text-[11px] tracking-[0.14em] uppercase font-medium rounded-full py-3.5 px-9">
            CONTACT US
        </x-ui.buttonClear>
    </div>
