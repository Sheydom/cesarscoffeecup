<section class="px-5 py-15 mt-10 flex flex-col justify-center bg-pastel">
    <div class="mb-10 sm:mx-auto  sm:text-center sm:w-max">
        <span class="text-xs text-coffeDark">IS THIS FOR YOU?</span>
        <h2 class="text-4xl mb-5 text-black">Build for businesses at every stage</h2>
