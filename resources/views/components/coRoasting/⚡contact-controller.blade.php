...
<section class="p-5 md:flex md:items-end md:justify-center gap-10 lg:gap-20 lg:p-15">
    <form id="coRoastingForm" class="bg-pastel flex flex-col h-full  shadow-md md:flex-row md:gap-10  rounded p-5 lg:p-10"
        ...
        <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-2 gap-6">
                ...
                <div class="flex w-full gap-5">
                    <div class="flex w-full flex-col mb-5"><label for="firstName">First Name</label><input
                            wire:model="name" required id="firstName" name="name"
                ...
                <div class="flex flex-col mb-5"><label for="email">Email Address</label><input id="email"
                        required wire:model="email" name="email"
            ...
            <div>
                <div class="flex flex-col mb-5"><label for="typeOf">Type of enquiry</label><select required
                        id="typeOf" name="typeOf" wire:model="typeOf"
                        class="p-2.5 bg-neutral border-b-2 rounded border-black" type="select"
                ...
                <div class="flex flex-col mb-5">
                    ...
                    <div id="level"
                        ...
                        <label for="beginner">Beginner</label><input required id="beginner" class=" "
                            type="radio" name="experience" wire:model="experience" value="Beginner">
                        <label for="some">Some</label><input id="some" class=" " type="radio"
                            value="Some" name="experience" wire:model="experience">
