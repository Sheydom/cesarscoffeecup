...
<section class="p-5 md:flex md:items-end md:justify-center gap-10 lg:gap-20 lg:p-15">
    <div class="flex flex-col gap-5">
        ...
        <div class="flex gap-5 mb-10 items-start">
            <svg class="shrink-0 h-7 w-7 text-coffeDark" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 640"><!--!Font Awesome Free v7.2.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.-->
                <path fill="currentColor"
    ...
    <form wire:submit.prevent="homeSubmit" id="homeForm"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex flex-col md:col-span-2">
                <label for="select">Type of enquiry</label>
                <select id="select" name="typeOf" wire:model="typeOf" required
            ...
            <div class="flex flex-col md:col-span-2">
                ...
                <textarea id="message" name="message" wire:model="message" required
