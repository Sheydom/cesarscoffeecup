<section class="px-5 mt-10 flex flex-col justify-center">
    ...
    <div class="flex flex-col gap-6 md:grid md:grid-cols-3 md:gap-6 lg:grid-cols-[350px_350px_350px]  lg:justify-center  ">
        <a href="{{route('home')}}#homeContactForm" class="bg-pastel/60 flex flex-col justify-between text-white p-5 drop-shadow shadow-md sm:mb-0 sm:p-10 sm:drop-shadow-xl border-transparent border-2 hover:border-2 hover:border-coffeDark hover:-translate-y-2 hover:scale-105 transform-gpu  hover:cursor-pointer transition duration-300 ease-in-out">
            <div class="mb-5">
                ...
                <button type="button" class="p-5 border rounded border-black bg-white text-primary text-center">HIRE A ROASTER</button>
            </a>
            <a href="{{route('coRoasting')}}#sessionsPrice" class=" bg-pastel/60 border-2 border-primary flex flex-col justify-between text-white p-5  drop-shadow shadow-md sm:mb-0 sm:p-10 sm:drop-shadow-xl  hover:border-2 hover:border-coffeDark hover:-translate-y-2 hover:scale-105 transform-gpu  hover:cursor-pointer transition duration-300 ease-in-out">
                <div class="mb-5">
                    <div class=" flex justify-end ">
                ...
                <button type="button"  class="p-5 border rounded border-black bg-white text-coffeDark text-center">BOOK A SESSION</button>
            </a>
