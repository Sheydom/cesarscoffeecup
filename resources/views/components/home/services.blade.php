<section class="px-5 mt-10 flex flex-col justify-center">
    ...
    <div
        class="flex flex-col gap-6 md:grid md:grid-cols-3 md:gap-6 lg:grid-cols-[350px_350px_350px]  lg:justify-center  ">
        <a href="{{ route('home') }}#homeForm"
        ...
        <a href="{{ route('coRoasting') }}#sessionsPrice"
            ...
            <div class="mb-5">
                ...
                <p class="text-black">Share our state-of-the-art facility. Perfect for independent roasters looking for
                    premium gear without the overhead.</p>
            </div>
            <button type="button" class="p-5 border rounded border-black bg-white text-coffeDark text-center">BOOK A
                SESSION</button>
        </a>
        ...
        <div
            ...
            <div class="mb-5">
                ...
                <h2 class="text-3xl mb-5 font-bodoni  text-coffeDark">Wholesale</h2>
                <p class="text-black">
